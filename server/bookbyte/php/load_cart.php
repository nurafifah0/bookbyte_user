...
$userid = $_GET['userid'];
$sqllodcart = "SELECT * FROM `tbl_cart` INNER JOIN tbl_books ON tbl_cart.book_id = tbl_books.book_id WHERE tbl_cart.buyer_id = '$userid' AND tbl_cart.cart_status = 'New'";
